...
public class clvswipe extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.example.clvswipe");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.example.clvswipe.class).invoke(this, new Object[] {null});
        else
...
b4a.example.clvswipe._swipeitem _m = null;
int _newleft = 0;
...
if (__c.Not(_item.Value instanceof b4a.example.clvswipe._swipeitem)) { 
if (true) return __c.False;};
 //BA.debugLineNum = 59;BA.debugLine="Dim m As SwipeItem = item.Value";
_m = (b4a.example.clvswipe._swipeitem)(_item.Value);
...
public b4a.example.clvswipe._swipeitem  _createitemvalue(Object _value,anywheresoftware.b4a.objects.collections.List _actions) throws Exception{
b4a.example.clvswipe._swipeitem _m = null;
...
_m = new b4a.example.clvswipe._swipeitem();
